...
namespace SkToolbox.SkModules
{
    public class ModConsoleOpt : SkBaseModule, IModule
    {
        ...
        {
            base.ModuleName = "Toolbox Controller";
            base.Loading();
        ...
        public void BeginMenu()
        {
            ...
            consoleOptMenu.AddItem("Debug Stations", new Action(DebugStations));
            consoleOptMenu.AddItem("Debug Paths", new Action(DebugPaths));
            consoleOptMenu.AddItem("Stop Debugging", new Action(StopDebugging));
        ...
        {
            DevStationView.Instance.StopDebugging();

            DevStationView.Instance.StartDebugging();
        }

        public void DebugPaths()
        {
            DevPathfindView.Instance.RemoveDebugging();
            DevPathfindView.Instance.StopDebugging();

            DevPathfindView.Instance.StartDebugging();
        }
